    ...
    <div>
      ...
      <section className="flex h-screen">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/HeroSection4.png')",
          }}
        >
          ...
          <div className="absolute bottom-20 left-12 text-white">
            ...
            <h2 className="text-6xl font-bold text-white">Video Content.</h2>
            <button className="mt-4 relative group px-6 py-3 text-white font-bold inline-block">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center max-w-md">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Contact me for a professional to help develop custom software
                solutions for your business. Once the project is complete,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col items-start text-left group">
                ...
                <p className="text-sm text-gray-400">
                  Our production services can put the finishing touches.
                </p>
              </div>
              ...
              <div className="flex flex-col items-start text-left group">
                ...
                <p className="text-sm text-gray-400">
                  Get your websites hosted securely and reliably.
                </p>
              </div>
            </div>
          </div>
